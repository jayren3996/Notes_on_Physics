...
\begin{equation}
	...
	= \mathbb{E}_{u_a} \includegraphics[align=c,width=0.2\linewidth]{pics/decode-2}
	= \frac{1}{3} + \frac{2}{3} F_\mathrm{EPR},\quad F_\mathrm{EPR} \equiv \includegraphics[align=c,width=0.18\linewidth]{pics/decode-3}.
\end{equation}
...
\begin{equation}
	|\Psi\rangle = \includegraphics[align=c,width=0.28\linewidth]{pics/qn-1.jpg}, \quad
	\rho(\mathrm{MEM}\cup q_n) = \frac{1}{2}\includegraphics[align=c,width=0.22\linewidth]{pics/qn-2.jpg}.
\end{equation}
...
\begin{equation}\label{eq:purity-network}
	...
	= \frac{1}{4^N}\includegraphics[align=c,width=0.18\linewidth]{pics/qn-3.jpg}
	= \frac{1}{4^{N+1}}\sum_{W,V}\includegraphics[align=c,width=0.18\linewidth]{pics/qn-4.jpg},
\end{equation}
...
\begin{equation}
	...
	= \frac{1}{2^{N+1+E}}\includegraphics[align=c,width=0.22\linewidth]{pics/decode-5}.
\end{equation}
...
\begin{equation}\label{eq:EPR-fidelity}
	F_{\mathrm{EPR}} = \includegraphics[align=c,width=0.2\linewidth]{pics/decode-6}/\Delta
...
\begin{equation}
	\langle e |_i = \delta_{i_i \bar i_1}\cdots \delta_{i_n\bar i_n} 
...
\begin{equation}\label{eq:random-circuit}
	|\psi(t)\rangle = U_\text{circuit}(t)|\psi_0\rangle =  \includegraphics[align=c,width=0.3\linewidth]{pics/circuit.jpg}.
\end{equation}
...
\begin{equation}
	...
	= \sum_{\tau=e, (12)} \operatorname{Wg}_d (\sigma_a \tau^{-1}) q^{\#(\sigma_b^{-1}\tau)+\#(\sigma_c^{-1}\tau)}
	=\begin{cases}
...
\begin{equation}
	\langle Z_n^k\rangle = \includegraphics[align=c,width=0.18\linewidth]{pics/boundary.jpg}, \quad
...
\begin{equation*}
	...
	\quad \Longrightarrow \quad
	Z = \includegraphics[align=c,width=0.25\linewidth]{pics/MIPT-2.jpg}
	\xrightarrow{\text{ average }} \includegraphics[align=c,width=0.25\linewidth]{pics/MIPT-3.jpg}
\end{equation*}
